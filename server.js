...
const server = http.createServer((req, res) => {
    ...
    if (page == "/random") {
        ...
        if (params["user"]) {
            ...
            response = {
                error: "please input your choice in the url as a query like ?user=paper",
            };
        }
...
const winnerWinner = (userDinner, computerDinner) => {
    ...
    if (userDinner === computerDinner) {
        ...
        (userDinner === "rock" &&
            (computerDinner === "scissors" || computerDinner === "lizard")) ||
        (userDinner === "paper" &&
            (computerDinner === "rock" || computerDinner === "spock")) ||
        (userDinner === "scissors" &&
            (computerDinner === "paper" || computerDinner === "lizard")) ||
        (userDinner === "lizard" &&
            (computerDinner === "paper" || computerDinner === "spock")) ||
        (userDinner === "spock" &&
            (computerDinner === "rock" || computerDinner === "scissors"))
    ) {
        winner = "user";
    } else {
        winner = "computer";
